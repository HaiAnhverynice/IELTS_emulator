...
- **Auto-marking & band estimate** — Reading is marked against an answer key and
...
- **Five full original practice tests** (Academic) included, plus the importer for your own.
...
src/
  ...
  components/
    ...
    modules/                   # ReadingTest, WritingTest
