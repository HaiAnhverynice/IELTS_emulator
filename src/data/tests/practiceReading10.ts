        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'The ancient Olympic Games were held in Greece.', evidence: 'The ancient Games were held in Greece, at the sacred site of Olympia' },
              { number: 2, text: 'The ancient Games were held every year.', evidence: 'They were not an annual event but were staged once every four years' },
              { number: 3, text: 'The modern Games were revived by Pierre de Coubertin.', evidence: 'Their revival was largely the work of one man, a French educator named Pierre de Coubertin' },
              { number: 4, text: 'The first modern Games were held in Paris.', evidence: 'the first modern Olympic Games opened in Athens in 1896' },
              { number: 5, text: 'Women competed at the first modern Games in 1896.', evidence: 'Women competed for the first time at the following Games, held in 1900' },
          ...
          },
          {
            ...
            questions: [
              { number: 7, text: 'The ancient Games were held at the site of ___.', evidence: 'The ancient Games were held in Greece, at the sacred site of Olympia' },
              { number: 8, text: 'The first modern Games opened in the year ___.', evidence: 'the first modern Olympic Games opened in Athens in 1896' },
              { number: 9, text: 'The first modern Games were held in ___.', evidence: 'the first modern Olympic Games opened in Athens in 1896' },
              { number: 10, text: 'The Games are staged once every ___ years.', evidence: 'were staged once every four years, a span the Greeks called an Olympiad' },
            ],
          },
          {
            ...
            questions: [
              { number: 11, text: 'Who was mainly responsible for reviving the modern Games?', evidence: 'Their revival was largely the work of one man, a French educator named Pierre de Coubertin' },
              { number: 12, text: 'In which year did women first take part?', evidence: 'Women competed for the first time at the following Games, held in 1900' },
              { number: 13, text: 'Besides the summer Games, what other Games now exist?', evidence: 'A separate Winter Games, for sports played on snow and ice, was added in the twentieth century' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            options: headings,
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'Long before anyone learned to make it, glass already existed in nature.' },
              { number: 15, text: 'Paragraph B', evidence: 'The first glass made by human hands appeared in the ancient Near East' },
              { number: 16, text: 'Paragraph C', evidence: 'Everything changed with the invention of glass-blowing.' },
              { number: 17, text: 'Paragraph D', evidence: 'Later, flat glass transformed buildings.' },
              { number: 18, text: 'Paragraph E', evidence: 'Glass also opened up the universe.' },
              { number: 19, text: 'Paragraph F', evidence: 'Glass is still being reinvented.' },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'forms naturally where volcanoes erupt', evidence: 'some of the molten rock can cool so quickly that it hardens into a natural glass called obsidian' },
              { number: 21, text: 'is shaped cheaply by blowing air into molten glass', evidence: 'By gathering molten glass on the end of a hollow rod and blowing air into it, a worker could shape a hollow vessel in seconds.' },
              { number: 22, text: 'bends light in order to magnify objects', evidence: 'Because it can be shaped into lenses that bend light, glass made possible the telescope and the microscope' },
              { number: 23, text: 'carries information across the world as light', evidence: 'fine threads of ultra-pure glass — optical fibres — carry vast amounts of information across the world as flashes of light' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'Natural glass such as obsidian is formed by', evidence: 'When a volcano erupts, some of the molten rock can cool so quickly that it hardens into a natural glass called obsidian', options: [{ value: 'A', label: 'rivers.' }, { value: 'B', label: 'volcanoes.' }, { value: 'C', label: 'wind.' }] },
              { number: 25, text: 'Glass-blowing made glass containers', evidence: 'This made glass containers cheap and common for the first time', options: [{ value: 'A', label: 'cheaper and more common.' }, { value: 'B', label: 'rarer and dearer.' }, { value: 'C', label: 'much heavier.' }] },
              { number: 26, text: 'Glass lenses were especially important for', evidence: 'glass made possible the telescope and the microscope, instruments that revealed worlds too distant or too small for the naked eye and helped science advance', options: [{ value: 'A', label: 'farming.' }, { value: 'B', label: 'science.' }, { value: 'C', label: 'cooking.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'In most bird species, it is the male that sings.', evidence: 'In most species it is the male that sings, advertising his fitness and his ownership of a patch of ground' },
              { number: 28, text: 'All birds are born already knowing their songs.', evidence: 'Birds are not simply born knowing their songs.' },
              { number: 29, text: 'Birds sing at dawn partly because the still air carries sound well.', evidence: 'the still morning air carries sound farthest, so a bird singing at dawn can be heard over the greatest distance' },
              { number: 30, text: 'City birds tend to sing more quietly than country birds.', evidence: 'some city birds now sing at a higher pitch, or more loudly, to be heard above the din' },
          ...
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'used above all to defend a territory against rivals and to attract a mate' },
              { number: 33, evidence: 'used above all to defend a territory against rivals and to attract a mate' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'used above all to defend a territory against rivals' },
              { number: 35, evidence: 'to defend a territory against rivals and to attract a mate' },
              { number: 36, evidence: 'In most species it is the male that sings' },
              { number: 37, evidence: 'many young birds learn their songs by listening to the adults around them' },
              { number: 38, evidence: 'the dawn chorus, when birds sing most intensely' },
              { number: 39, evidence: 'the constant noise of traffic can drown out' },
              { number: 40, evidence: 'some city birds now sing at a higher pitch' },
            ],
          },
        ],
      },
