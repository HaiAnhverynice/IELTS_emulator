        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Cacao trees originally grew in Central and South America.', evidence: 'Chocolate comes from the cacao tree, which is native to the tropical forests of Central and South America.' },
              { number: 2, text: 'The Aztecs used cacao beans as a form of money.', evidence: 'they even used the beans themselves as a form of money.' },
              { number: 3, text: 'Europeans preferred their chocolate drink without sugar.', evidence: 'When Spanish explorers carried cacao back to Europe in the sixteenth century, Europeans added sugar to the bitter drink.' },
              { number: 4, text: 'Chocolate was affordable for most Europeans when it was first introduced.', evidence: 'because it was expensive, it was enjoyed only by the wealthy.' },
              { number: 5, text: 'The first solid eating bar was made in Switzerland.', evidence: "In 1847 the British firm Fry's produced the first moulded eating bar" },
          ...
          },
          {
            ...
            questions: [
              { number: 7, evidence: 'The Maya, and later the Aztecs, valued cacao very highly.' },
              { number: 8, evidence: 'they even used the beans themselves as a form of money.' },
              { number: 9, evidence: 'When Spanish explorers carried cacao back to Europe in the sixteenth century' },
              { number: 10, evidence: 'Europeans added sugar to the bitter drink.' },
            ],
          },
          {
            id: 'r1c',
            ...
            questions: [
              { number: 11, text: "In which year did Fry's produce the first eating bar?", evidence: "In 1847 the British firm Fry's produced the first moulded eating bar" },
              { number: 12, text: 'Which two makers created milk chocolate?', evidence: 'the Swiss makers Daniel Peter and Henri Nestlé mixed chocolate with condensed milk to create milk chocolate' },
              { number: 13, text: 'In which region is most cacao grown today?', evidence: 'most cacao is now grown by small farmers in West Africa' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'When the pandemic forced offices to close, millions of people began working from home' },
              { number: 15, text: 'Paragraph B', evidence: 'For many employees, the gains were immediate.' },
              { number: 16, text: 'Paragraph C', evidence: 'Employers saw advantages too, chiefly lower spending on office space. But there were concerns.' },
              { number: 17, text: 'Paragraph D', evidence: 'Remote work also created difficulties for the workers themselves.' },
              { number: 18, text: 'Paragraph E', evidence: 'Companies responded in very different ways.' },
              { number: 19, text: 'Paragraph F', evidence: 'The likeliest outcome is a hybrid arrangement that combines time at home with time together in person.' },
            ],
          },
          {
            id: 'r2b',
            ...
            questions: [
              { number: 20, text: 'has gone fully remote permanently', evidence: 'TechCorp announced that it would remain fully remote permanently.' },
              { number: 21, text: 'requires all staff to return full-time', evidence: 'BankCo, by contrast, ordered all its staff back to the office full-time.' },
              { number: 22, text: 'lets each team choose its own schedule', evidence: 'DesignStudio chose to let each team decide its own schedule' },
              { number: 23, text: 'requires three office days a week', evidence: 'RetailPlus settled on a rule of three days a week in the office.' },
            ],
          },
          {
            id: 'r2c',
            ...
            instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'According to the passage, the main benefit for employees is', evidence: 'There was no daily commute to drain time and money, schedules became more flexible', options: [{ value: 'A', label: 'higher pay.' }, { value: 'B', label: 'flexibility and no commute.' }, { value: 'C', label: 'faster promotion.' }] },
              { number: 25, text: 'A key concern for employers is', evidence: 'many worried that creativity and teamwork suffered when colleagues rarely met face to face', options: [{ value: 'A', label: 'higher office costs.' }, { value: 'B', label: 'weaker teamwork.' }, { value: 'C', label: 'losing customers.' }] },
              { number: 26, text: 'The writer predicts that the future of work will be', evidence: 'The likeliest outcome is a hybrid arrangement that combines time at home with time together in person.', options: [{ value: 'A', label: 'fully office-based.' }, { value: 'B', label: 'fully remote.' }, { value: 'C', label: 'hybrid.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Scientists fully understand how birds detect the magnetic field.', evidence: 'Exactly how they detect it is not yet fully understood' },
              { number: 28, text: 'Birds use more than one method to navigate.', evidence: 'What is now clear is that birds do not rely on a single method.' },
              { number: 29, text: 'Some young birds have an inborn sense of direction.', evidence: 'Many young birds appear to inherit a direction instinctively' },
              { number: 30, text: 'Experienced birds rely only on landmarks.', evidence: 'Experienced birds, however, build something more powerful: a mental map of where they are' },
          ...
          },
          {
            ...
            instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 32, text: 'At night, migrating birds may navigate using', evidence: 'By night, others steer by the pattern of the stars.', options: [{ value: 'A', label: 'the sun.' }, { value: 'B', label: 'the stars.' }, { value: 'C', label: 'their sense of smell.' }] },
              { number: 33, text: 'Sensing the magnetic field may involve', evidence: "the leading ideas point to light-sensitive chemical reactions in the bird's eye, or to tiny particles of iron in its beak", options: [{ value: 'A', label: 'the wings.' }, { value: 'B', label: 'the eye or the beak.' }, { value: 'C', label: 'the feet.' }] },
              { number: 34, text: 'In the experiments described, birds carried off route', evidence: 'birds that were deliberately carried far off route were still able to find their way back on track', options: [{ value: 'A', label: 'became permanently lost.' }, { value: 'B', label: 'corrected their course.' }, { value: 'C', label: 'stopped migrating.' }] },
              { number: 35, text: 'Compared with young birds, experienced birds have', evidence: 'Experienced birds, however, build something more powerful: a mental map of where they are', options: [{ value: 'A', label: 'no sense of direction.' }, { value: 'B', label: 'a learned mental map.' }, { value: 'C', label: 'sharper eyesight.' }] },
            ],
          },
          {
            id: 'r3c',
            ...
            questions: [
              { number: 36, evidence: 'many species use the position of the sun' },
              { number: 37, evidence: 'By night, others steer by the pattern of the stars.' },
              { number: 38, evidence: "the most remarkable cue is the Earth's magnetic field" },
              { number: 39, evidence: 'following familiar landmarks such as rivers and coastlines' },
              { number: 40, evidence: 'Many young birds appear to inherit a direction instinctively' },
            ],
          },
        ],
      },
