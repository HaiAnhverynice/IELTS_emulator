        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'The first draisine had pedals.', evidence: 'It had two wheels and a frame but no pedals; the rider simply pushed along the ground with their feet.' },
              { number: 2, text: 'The "boneshaker" gave an uncomfortable ride.', evidence: 'because its iron-banded wheels made for a thoroughly uncomfortable ride on cobbled streets' },
              { number: 3, text: 'The penny-farthing was safer than earlier machines.', evidence: 'the high seat made falls genuinely dangerous' },
              { number: 4, text: 'The safety bicycle had two wheels of the same size.', evidence: 'the "safety bicycle" of the 1880s, with two wheels of equal size and a chain driving the rear wheel' },
              { number: 5, text: 'John Dunlop invented the chain drive.', evidence: 'the air-filled tyre, patented by John Dunlop in 1888' },
          ...
          },
          {
            ...
            questions: [
              { number: 7, text: 'The draisine was invented by Karl ___ in 1817.', evidence: 'was invented by Karl Drais in Germany in 1817' },
              { number: 8, text: 'Pedals were first added in the ___.', evidence: 'Pedals were added in the 1860s, creating the "velocipede"' },
              { number: 9, text: 'The air-filled tyre was patented in ___.', evidence: 'the air-filled tyre, patented by John Dunlop in 1888' },
            ],
          },
          {
            ...
            questions: [
              { number: 10, text: 'In which country was the draisine invented?', evidence: 'was invented by Karl Drais in Germany in 1817' },
              { number: 11, text: 'What was the velocipede nicknamed?', evidence: 'creating the "velocipede", soon nicknamed the "boneshaker"' },
              { number: 12, text: 'Which wheel did the chain drive on the safety bicycle?', evidence: 'a chain driving the rear wheel' },
              { number: 13, text: 'What is the bicycle said to have given women?', evidence: 'giving women, in particular, a new freedom of movement' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            options: headings,
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'The story of coffee begins with a legend.' },
              { number: 15, text: 'Paragraph B', evidence: 'From Arabia the drink travelled widely.' },
              { number: 16, text: 'Paragraph C', evidence: 'Coffee grows only in warm climates, in a band around the equator often called the "coffee belt".' },
              { number: 17, text: 'Paragraph D', evidence: 'Turning the fruit into a drink takes several steps.' },
              { number: 18, text: 'Paragraph E', evidence: 'Coffee is also big business — one of the most heavily traded commodities in the world.' },
              { number: 19, text: 'Paragraph F', evidence: 'Finally, what of its effects on us?' },
            ],
          },
          {
            ...
            options: places,
            questions: [
              { number: 20, text: 'where the legend of Kaldi is set', evidence: 'An Ethiopian goatherd named Kaldi, it is said, noticed that his goats became lively after eating the berries of a certain bush.' },
              { number: 21, text: 'where the first coffee houses opened', evidence: 'The first coffee houses opened in the cities of the Middle East' },
              { number: 22, text: 'where coffee houses became centres of conversation in the 17th century', evidence: 'by the seventeenth century they had reached Europe, where they quickly became lively centres of conversation, business and debate' },
              { number: 23, text: 'where coffee is grown', evidence: 'Coffee grows only in warm climates, in a band around the equator often called the "coffee belt".' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'The two main species of coffee are', evidence: 'Two species dominate the trade: arabica, prized for its flavour, and robusta, which is hardier and higher in caffeine.', options: [{ value: 'A', label: 'arabica and robusta.' }, { value: 'B', label: 'arabica and Kaldi.' }, { value: 'C', label: 'robusta and fair trade.' }] },
              { number: 25, text: 'During processing, after the cherries are picked, the beans are first', evidence: 'The ripe red cherries are picked, the beans inside are dried, and only later are they roasted', options: [{ value: 'A', label: 'roasted.' }, { value: 'B', label: 'dried.' }, { value: 'C', label: 'ground.' }] },
              { number: 26, text: 'The passage says most coffee is grown by', evidence: 'much of it is grown by small farmers who earn very little', options: [{ value: 'A', label: 'large companies.' }, { value: 'B', label: 'small farmers.' }, { value: 'C', label: 'governments.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Laughter is found in every culture that has been studied.', evidence: 'It is found in every culture ever studied' },
              { number: 28, text: 'Babies learn to laugh only after they can speak.', evidence: 'babies begin to laugh long before they can speak, at around four months old' },
              { number: 29, text: 'Humans are the only animals capable of laughter.', evidence: 'Researchers have recorded laughter-like sounds in chimpanzees and other apes when they play' },
              { number: 30, text: 'People laugh more in company than when they are alone.', evidence: 'We laugh far more often in the company of other people than we do alone' },
          ...
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'it helps to build and strengthen the bonds between members of a group' },
              { number: 33, evidence: 'a good laugh may also help to relieve stress' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'It is found in every culture ever studied' },
              { number: 35, evidence: 'Researchers have recorded laughter-like sounds in chimpanzees and other apes when they play' },
              { number: 36, evidence: 'babies begin to laugh long before they can speak, at around four months old' },
              { number: 37, evidence: 'Perhaps the most surprising finding is how social laughter is.' },
              { number: 38, evidence: 'We laugh far more often in the company of other people than we do alone' },
              { number: 39, evidence: 'only a small fraction of everyday laughter actually follows a joke' },
              { number: 40, evidence: 'it helps to build and strengthen the bonds between members of a group' },
            ],
          },
        ],
      },
