        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Before printing, books were cheap and widely owned.', evidence: 'Books were therefore rare and extremely costly, owned only by the wealthy, by churches and by the few universities that existed.' },
              { number: 2, text: 'Movable type was first invented in Asia.', evidence: 'Movable type — separate pieces for each character that could be arranged and reused — was also invented in Asia.' },
              { number: 3, text: 'The large number of Chinese characters made movable type awkward in China.', evidence: 'the Chinese script contains thousands of different characters, which made movable type awkward to use there' },
              { number: 4, text: 'Gutenberg was wealthy before he built his press.' },
              { number: 5, text: 'Printing presses spread across Europe within a few decades.', evidence: 'Within a few decades printing presses had been set up in cities all across Europe' },
              { number: 6, text: 'Most early printed books were written in everyday languages.', evidence: 'At first most books were printed in Latin, the language of scholars' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'Printing from carved wooden blocks was first developed in ___.', evidence: 'In China, craftsmen learned to carve a whole page of text into a block of wood, ink it, and press it onto paper' },
              { number: 8, text: 'The decisive breakthrough in Europe is credited to ___.', evidence: 'is usually credited to a German craftsman named Johannes Gutenberg' },
              { number: 9, text: 'Gutenberg cast his individual letters in ___.', evidence: 'He cast individual letters in metal, which were hard-wearing' },
              { number: 10, text: 'His most famous printed work was an edition of the ___.', evidence: "Gutenberg's most famous product was a printed edition of the Bible" },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'Before printing, what had to be copied out by hand?', evidence: 'a world in which every book had to be copied out by hand' },
              { number: 12, text: 'In which language were most books first printed?', evidence: 'At first most books were printed in Latin, the language of scholars' },
              { number: 13, text: 'Compared with handwritten books, what were printed books?', evidence: 'Because printed books were so much cheaper than handwritten ones, far more people could own them' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            options: beeHeadings,
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'A honeybee colony is one of the most highly organised societies in nature.' },
              { number: 15, text: 'Paragraph B', evidence: 'The food that fuels the colony is, of course, honey, and making it is a long process.' },
              { number: 16, text: 'Paragraph C', evidence: 'One of the most astonishing things bees do is tell one another where food is to be found.' },
              { number: 17, text: 'Paragraph D', evidence: 'Bees matter to people far beyond the honey they make.' },
              { number: 18, text: 'Paragraph E', evidence: 'For all their importance, bees are now in trouble.' },
              { number: 19, text: 'Paragraph F', evidence: 'The good news is that ordinary people can do a great deal to help.' },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'build the comb, guard the hive and care for the young', evidence: 'The workers divide the labour among themselves, building the comb, cleaning the hive, guarding the entrance, caring for the young and gathering food' },
              { number: 21, text: 'lays the eggs for the whole colony', evidence: 'At the centre of it all is a single queen, whose role is to lay eggs' },
              { number: 22, text: 'collect nectar from flowers and carry it home', evidence: 'Foraging bees suck up a sugary liquid called nectar from flowers and carry it back to the hive in a special stomach' },
              { number: 23, text: 'exist only to mate', evidence: 'a small number of males exist only to mate' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'Honey is made by removing from nectar most of its', evidence: 'the watery part is gradually driven off, until what remains is the thick, sweet substance we know as honey', options: [{ value: 'A', label: 'sugar.' }, { value: 'B', label: 'water.' }, { value: 'C', label: 'colour.' }] },
              { number: 25, text: 'A bee tells others where food is by means of', evidence: 'returns to the hive and performs a kind of dance on the surface of the comb', options: [{ value: 'A', label: 'a loud sound.' }, { value: 'B', label: 'a scent trail.' }, { value: 'C', label: 'a dance.' }] },
              { number: 26, text: 'Bees help to produce much of our food by', evidence: 'they carry pollen with them, and in doing so they fertilise the plants and allow them to produce seeds and fruit', options: [{ value: 'A', label: 'pollinating crops.' }, { value: 'B', label: 'eating harmful pests.' }, { value: 'C', label: 'enriching the soil.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'People who live near good green space tend to be more active.', evidence: 'those who live close to good green space tend to be more physically active and, on average, healthier than those who do not' },
              { number: 28, text: 'Densely built city areas are cooler than the surrounding countryside.', evidence: "Densely built areas of concrete and brick soak up the sun's heat and grow noticeably hotter than the countryside around them" },
              { number: 29, text: 'Plants and soil can reduce the risk of flooding in cities.', evidence: 'Soil and plants, by contrast, soak up rainfall like a sponge and release it slowly, easing the strain on the drains and reducing the risk of floods' },
              { number: 30, text: 'City parks are more popular with adults than with children.' },
              { number: 31, text: 'Planners now regard green space as an unnecessary luxury.', evidence: 'planners increasingly treat green space not as a luxury to be added if money allows, but as an essential part of a healthy city' },
            ],
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'Trees and plants help to clean the air, trapping some of the dust and pollution that traffic and industry pour out.' },
              { number: 33, evidence: 'parks, gardens and ponds provide a refuge for wildlife' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'a generous cover of trees can lower the temperature of a neighbourhood' },
              { number: 35, evidence: 'When rain falls on a city of hard surfaces' },
              { number: 36, evidence: 'trapping some of the dust and pollution that traffic and industry pour out' },
              { number: 37, evidence: 'those who live close to good green space tend to be more physically active' },
              { number: 38, evidence: 'people who spend time in natural surroundings report lower levels of stress and better moods' },
              { number: 39, evidence: 'parks, gardens and ponds provide a refuge for wildlife' },
              { number: 40, evidence: 'sometimes overwhelming the drains and causing flooding' },
            ],
          },
        ],
      },
