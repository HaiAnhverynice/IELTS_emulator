        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Chocolate was originally consumed as a drink rather than a solid food.', evidence: 'For most of its history chocolate was not eaten at all but drunk' },
              { number: 2, text: 'The ancient drink made from cacao was sweetened with sugar.', evidence: 'it contained no sugar and was usually flavoured with chilli, which made it sharp and bitter rather than sweet' },
              { number: 3, text: 'Cacao beans were once used as money.', evidence: 'So highly was cacao prized that the beans were used as a form of money' },
              { number: 4, text: 'Chocolate houses were more popular than coffee houses in Europe.' },
              { number: 5, text: 'Milk chocolate was invented before solid eating chocolate.', evidence: 'produced the first true eating chocolate, a solid bar rather than a drink' },
              { number: 6, text: 'Most cacao beans today come from West Africa.', evidence: "most of the world's beans now come from West Africa" },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'The first people to use cacao were the ___ and, later, the Aztecs.', evidence: 'The Maya, and later the Aztecs, roasted and ground the beans' },
              { number: 8, text: 'The ancient cacao drink tasted sharp and ___.', evidence: 'which made it sharp and bitter rather than sweet' },
              { number: 9, text: 'Europeans made chocolate popular by adding ___.', evidence: 'once people began to sweeten it with sugar and to warm it, it became hugely fashionable' },
              { number: 10, text: 'Milk chocolate was first developed in ___.', evidence: 'In Switzerland, one maker discovered that adding milk produced a paler, creamier and far gentler chocolate' },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'What are the seeds of the cacao tree usually called?', evidence: 'inside each pod sit dozens of seeds, usually called beans' },
              { number: 12, text: 'Which European country received cacao first?', evidence: 'The new drink reached Spain before any other European country' },
              { number: 13, text: 'What form of chocolate did nineteenth-century inventors finally manage to make?', evidence: 'produced the first true eating chocolate, a solid bar rather than a drink' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 14, text: 'Paragraph A', evidence: "Volcanoes are not scattered randomly across the globe but are concentrated along certain lines on the Earth's surface." },
              { number: 15, text: 'Paragraph B', evidence: 'Beneath every volcano lies a store of molten rock.' },
              { number: 16, text: 'Paragraph C', evidence: 'Not all volcanoes look the same, because the lava that builds them behaves in different ways.' },
              { number: 17, text: 'Paragraph D', evidence: 'One of the great aims of modern volcano science is to give warning before an eruption.' },
              { number: 18, text: 'Paragraph E', evidence: 'Eruptions can be enormously destructive.' },
              { number: 19, text: 'Paragraph F', evidence: 'Yet volcanoes are not only a threat, and this helps explain why people continue to live near them.' },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'the giant slabs of rock that make up the Earth’s outer shell', evidence: 'The outer shell of the planet is broken into a number of vast slabs of rock, called plates' },
              { number: 21, text: 'fine material that can blanket a region and dim sunlight', evidence: 'clouds of hot ash can blanket whole regions, collapsing roofs and ruining crops' },
              { number: 22, text: 'molten rock while it is still below the surface', evidence: 'rock melts into a thick, fiery liquid called magma' },
              { number: 23, text: 'molten rock once it has burst out at the surface', evidence: 'the magma forces its way upward through cracks and bursts out at the surface, where it is known as lava' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'Most volcanoes are found', evidence: 'Most volcanoes occur where two of these plates meet', options: [{ value: 'A', label: 'in the middle of continents.' }, { value: 'B', label: 'where two plates meet.' }, { value: 'C', label: 'far from any ocean.' }] },
              { number: 25, text: 'A broad, gently sloping volcano is built by lava that is', evidence: 'Where the lava is thin and runny, it flows easily and spreads out over great distances, building a broad, gently sloping mountain', options: [{ value: 'A', label: 'thin and runny.' }, { value: 'B', label: 'thick and sticky.' }, { value: 'C', label: 'cold and solid.' }] },
              { number: 26, text: 'One benefit of living near a volcano is', evidence: 'the ash and lava from past eruptions break down into some of the richest soils on Earth, ideal for farming', options: [{ value: 'A', label: 'protection from earthquakes.' }, { value: 'B', label: 'cooler summers.' }, { value: 'C', label: 'very fertile soil.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Red attracts the eye more strongly than other colours.', evidence: 'Red in particular seems to attract attention more strongly than any other colour' },
              { number: 28, text: 'The meaning of a colour is the same in every culture.', evidence: 'The associations a colour calls up depend heavily on culture and on personal experience.' },
              { number: 29, text: 'Blue is the most popular colour in surveys around the world.', evidence: "Blue, for example, is consistently named as the world's most popular colour in surveys carried out in many different countries" },
              { number: 30, text: 'Children prefer brighter colours than adults do.' },
              { number: 31, text: 'All popular claims about colour are well supported by evidence.', evidence: 'Many popular claims about colour — that a particular shade will calm an angry crowd, say, or boost a worker\'s output — turn out to be weakly supported or to vanish when tested carefully.' },
            ],
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'they are chosen for warning signs and safety equipment' },
              { number: 33, evidence: 'Fast-food chains often favour bright reds and yellows, colours thought to catch the eye and encourage hunger' },
            ],
          },
          {
            ...
            bodyHtml: `
              ...
              their {{40}}.</p>`,
            questions: [
              { number: 34, evidence: 'Red in particular seems to attract attention more strongly than any other colour' },
              { number: 35, evidence: 'Cool colours such as blue and green, by contrast, are restful to look at and are often described as calming' },
              { number: 36, evidence: 'certain shades can even influence appetite, which is of great interest to those who sell food' },
              { number: 37, evidence: 'The associations a colour calls up depend heavily on culture and on personal experience.' },
              { number: 38, evidence: 'they are chosen for warning signs and safety equipment' },
              { number: 39, evidence: 'It nudges our mood and our choices in small ways we seldom notice' },
              { number: 40, evidence: 'the colours of rival brands are chosen as deliberately as their names' },
            ],
          },
        ],
      },
