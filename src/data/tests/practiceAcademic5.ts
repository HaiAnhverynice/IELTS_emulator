        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Paper was invented in China.', evidence: 'It was invented in China around the year 105' },
              { number: 2, text: 'The earliest paper was made from plant fibres and rags.', evidence: 'The earliest paper was made from plant fibres and old rags' },
              { number: 3, text: 'Paper travelled directly from China to Europe.', evidence: 'Paper did not travel directly to Europe.' },
              { number: 4, text: 'Parchment was made from animal skin.', evidence: 'Europeans wrote mainly on parchment, which was made from animal skin' },
              { number: 5, text: 'Parchment was cheaper than paper.', evidence: 'Parchment was strong but extremely expensive, so the cheaper paper gradually replaced it.' },
          ...
          },
          {
            ...
            questions: [
              { number: 7, text: 'Paper was invented around the year ___.', evidence: 'It was invented in China around the year 105' },
              { number: 8, text: 'The invention is credited to a court official named ___.', evidence: 'traditionally credited to a court official named Cai Lun' },
              { number: 9, text: 'Paper spread to Europe through the ___ world.', evidence: 'it spread first through the Arab world' },
            ],
          },
          {
            ...
            questions: [
              { number: 10, text: 'What did Europeans mainly write on before paper?', evidence: 'Before paper arrived, Europeans wrote mainly on parchment' },
              { number: 11, text: 'What was parchment made from?', evidence: 'parchment, which was made from animal skin' },
              { number: 12, text: 'Which city was an early centre of paper-making in the Arab world?', evidence: 'the city of Samarkand became an early centre of paper-making' },
              { number: 13, text: 'What greatly increased the demand for paper in Europe?', evidence: 'Demand grew enormously once the printing press made books available to ordinary people.' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            options: headings,
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'people are not employed in steady, long-term jobs but are paid for short tasks' },
              { number: 15, text: 'Paragraph B', evidence: 'For many workers the appeal is freedom.' },
              { number: 16, text: 'Paragraph C', evidence: 'But there is a cost.' },
              { number: 17, text: 'Paragraph D', evidence: 'Businesses, meanwhile, have embraced the model enthusiastically.' },
              { number: 18, text: 'Paragraph E', evidence: 'All this has provoked a fierce legal argument.' },
              { number: 19, text: 'Paragraph F', evidence: 'What happens next is unclear.' },
            ],
          },
          {
            ...
            options: groups4,
            questions: [
              { number: 20, text: 'value the freedom to choose their own hours', evidence: 'They can choose when and how much to work, fitting jobs around studies, family or another career.' },
              { number: 21, text: 'save money by avoiding permanent staff', evidence: 'avoid the cost of permanent staff, which can make a young company far more competitive' },
              { number: 22, text: 'are debating whether gig workers are employees', evidence: 'Courts and governments around the world are still wrestling with the question.' },
          ...
          },
          {
            ...
            questions: [
              { number: 24, text: 'In the gig economy, work is usually arranged through', evidence: 'usually arranged through a smartphone app', options: [{ value: 'A', label: 'job centres.' }, { value: 'B', label: 'smartphone apps.' }, { value: 'C', label: 'newspapers.' }] },
              { number: 25, text: 'A drawback for gig workers is', evidence: 'Gig workers rarely receive the benefits that employees take for granted — paid holidays, sick pay, a pension.', options: [{ value: 'A', label: 'too little flexibility.' }, { value: 'B', label: 'a lack of benefits.' }, { value: 'C', label: 'very high pay.' }] },
              { number: 26, text: 'The central legal question is whether gig workers are', evidence: 'are they really employees who deserve the same rights?', options: [{ value: 'A', label: 'customers.' }, { value: 'B', label: 'employees.' }, { value: 'C', label: 'owners.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Colours can influence our mood and behaviour.', evidence: 'colours can influence our mood and behaviour, at least a little' },
              { number: 28, text: 'The colour red is associated with calmness.', evidence: 'Warm colours, and red above all, are associated with energy and excitement.' },
              { number: 29, text: 'Colour associations are the same in every culture.', evidence: 'Many of these associations are not universal but are learned within a culture.' },
              { number: 30, text: 'Businesses choose colours deliberately for their branding.', evidence: 'so many banks, insurers and technology companies choose blue for their logos' },
          ...
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'Blue, in particular, tends to feel calming, and it carries strong associations of trust and reliability.' },
              { number: 33, evidence: 'Blue, in particular, tends to feel calming, and it carries strong associations of trust and reliability.' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'colours can influence our mood and behaviour, at least a little' },
              { number: 35, evidence: 'Warm colours, and red above all, are associated with energy and excitement.' },
              { number: 36, evidence: 'Red is also thought to stimulate the appetite' },
              { number: 37, evidence: 'it appears so often in the branding of fast-food restaurants' },
              { number: 38, evidence: 'Blue, in particular, tends to feel calming' },
              { number: 39, evidence: 'it carries strong associations of trust and reliability' },
              { number: 40, evidence: 'Many of these associations are not universal but are learned within a culture.' },
            ],
          },
        ],
      },
