        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'The earliest two-wheeled machine had no pedals.', evidence: 'The earliest ancestor of the bicycle had no pedals at all.' },
              { number: 2, text: 'Machines with one huge front wheel were very safe to ride.', evidence: 'These were fast but dangerous, for the rider sat high above the ground and a fall could cause serious injury.' },
              { number: 3, text: 'The safety bicycle used a chain to drive the rear wheel.', evidence: 'inventors connected the pedals to the rear wheel by means of a chain' },
              { number: 4, text: 'Air-filled rubber tyres made cycling more comfortable.', evidence: 'air-filled tyres made of rubber replaced the hard wheels of earlier machines, giving a far smoother and more comfortable ride' },
              { number: 5, text: 'Bicycles were more expensive than horses to buy.' },
              { number: 6, text: 'Cycling had little effect on the clothes people wore.', evidence: 'It even influenced the clothes people wore, as the long, heavy garments of the day proved impractical for cycling.' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'The earliest machine proved that a rider could balance on two ___.', evidence: 'that a rider could indeed balance on two wheels while in motion' },
              { number: 8, text: 'A great step forward was adding ___ to turn a wheel.', evidence: 'The next great step was to add pedals, so that the rider\'s effort could turn a wheel directly' },
              { number: 9, text: 'The modern design connected the pedals to the rear wheel with a ___.', evidence: 'inventors connected the pedals to the rear wheel by means of a chain' },
              { number: 10, text: 'Air-filled tyres were made of ___.', evidence: 'air-filled tyres made of rubber replaced the hard wheels of earlier machines' },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'What name was given to the lower, more secure bicycle design?', evidence: 'this design was far less likely to throw them off, and it became known as the safety bicycle' },
              { number: 12, text: 'Whose lives is the bicycle said to have especially changed?', evidence: 'The bicycle is often said to have had an especially great effect on the lives of women' },
              { number: 13, text: 'Compared with keeping a horse, what was the bicycle?', evidence: 'It was cheaper than keeping a horse and needed no feeding or stabling' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'A desert is defined not by heat or by sand but by a single thing: a lack of water.' },
              { number: 15, text: 'Paragraph B', evidence: 'It is a common mistake to imagine that all deserts are hot.' },
              { number: 16, text: 'Paragraph C', evidence: 'The plants that manage to live in deserts are marvels of survival' },
              { number: 17, text: 'Paragraph D', evidence: 'Desert animals face the same challenge and have found their own answers.' },
              { number: 18, text: 'Paragraph E', evidence: 'Far from being featureless, deserts contain some of the most dramatic scenery on Earth' },
              { number: 19, text: 'Paragraph F', evidence: "A growing concern is that the world's deserts are spreading." },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'feed at night and rest in shade or burrows by day', evidence: 'Many avoid the worst of the heat by resting in burrows or shade during the day and coming out to feed in the cool of the night.' },
              { number: 21, text: 'can endure long journeys between water sources', evidence: 'The camel, with its ability to endure long journeys between water sources' },
              { number: 22, text: 'stores water in thick stems and is protected by spines', evidence: 'Some, like the cactus, store water in thick, fleshy stems and are protected by sharp spines instead of thirsty leaves.' },
              { number: 23, text: 'survive dry spells as seeds and flower quickly after rain', evidence: 'A few survive the long dry spells as seeds, springing up and flowering with astonishing speed in the rare days after rain.' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'A desert is defined by its lack of', evidence: 'A desert is defined not by heat or by sand but by a single thing: a lack of water.', options: [{ value: 'A', label: 'sand.' }, { value: 'B', label: 'heat.' }, { value: 'C', label: 'water.' }] },
              { number: 25, text: 'Hot deserts often become cold at night because the air is', evidence: "because the dry, cloudless air holds little of the day's warmth once the sun has set", options: [{ value: 'A', label: 'very dry.' }, { value: 'B', label: 'full of cloud.' }, { value: 'C', label: 'rich in moisture.' }] },
              { number: 26, text: 'Deserts are said to be spreading partly because of', evidence: 'a process driven partly by changes in climate and partly by human pressure', options: [{ value: 'A', label: 'too much rainfall.' }, { value: 'B', label: 'human pressure on the land.' }, { value: 'C', label: 'the planting of too many trees.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Memory works much like a camera, recording the world exactly.', evidence: 'Far from working like a camera that records the world exactly, memory is an active process in which the brain selects, stores and later rebuilds experiences.' },
              { number: 28, text: 'Most information in short-term memory is quickly lost.', evidence: 'Most of what passes through this store is quickly lost.' },
              { number: 29, text: 'Understanding the meaning of something aids memory more than repetition.', evidence: 'But repetition alone is far less powerful than understanding.' },
              { number: 30, text: 'Younger people forget more slowly than older people.' },
              { number: 31, text: 'Cramming the night before an exam produces the most durable memories.', evidence: 'Spreading study out over time, in gradual sessions rather than a single long cramming before an exam, produces far more durable memories.' },
            ],
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'people who sleep after learning something remember it better than those who stay awake' },
              { number: 33, evidence: 'Spreading study out over time, in gradual sessions rather than a single long cramming before an exam, produces far more durable memories.' },
            ],
          },
          {
            ...
            bodyHtml: `
              ...
              than cramming.</p>`,
            questions: [
              { number: 34, evidence: "the hours we spend asleep are when the brain does much of the work of fixing the day's experiences into lasting memory" },
              { number: 35, evidence: 'One factor that strengthens a memory is repetition' },
              { number: 36, evidence: 'When we grasp the meaning of something and link it to what we already know' },
              { number: 37, evidence: 'because cues help us retrieve, it helps to practise recalling information rather than only re-reading it' },
              { number: 38, evidence: 'because anxiety interferes with both storing and recalling' },
              { number: 39, evidence: 'a calm and confident state of mind, supported by proper sleep, allows the memory to do its best work' },
              { number: 40, evidence: 'in gradual sessions rather than a single long cramming before an exam' },
            ],
          },
        ],
      },
