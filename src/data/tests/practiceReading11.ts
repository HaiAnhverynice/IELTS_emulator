        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Tea is the second most popular drink in the world after water.', evidence: 'Tea is the most widely drunk beverage in the world after water' },
              { number: 2, text: 'Tea was first used in China as an everyday drink rather than as a medicine.', evidence: 'At first the leaves were valued chiefly as a medicine, taken to aid digestion or to drive away tiredness, and only later did tea become an everyday drink enjoyed for its taste.' },
              { number: 3, text: 'In some regions blocks of tea were used in place of money.', evidence: 'in some regions blocks of tea were even used as a form of money' },
              { number: 4, text: 'The first tea to reach Europe was cheaper than coffee.' },
              { number: 5, text: 'Britain set up tea plantations within its own empire.', evidence: 'Britain looked for places where tea could be grown within its own empire rather than bought from China alone' },
              { number: 6, text: 'India produced less tea than China by the end of the nineteenth century.', evidence: 'India in particular became one of the largest producers in the world' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'The tea plant is native to the borderlands of southern ___.', evidence: 'is native to the borderlands of southern China' },
              { number: 8, text: 'Tea is thought to have been carried to other lands by ___ monks.', evidence: 'Buddhist monks, who valued tea because it helped them stay awake during long hours of meditation, are believed to have carried both the plant and the custom' },
              { number: 9, text: 'The most famous trade network linking China with the West was the ___ Road.', evidence: 'The most famous of these networks, the Silk Road, gave its name to an entire age of exchange between East and West.' },
              { number: 10, text: 'Europeans drank their tea from cups made of ___.', evidence: 'delicate porcelain cups proved the ideal vessel from which to drink the new and fashionable beverage' },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'In which country did tea become part of a formal ceremony?', evidence: 'In this way tea reached Japan, where it was woven into a famous and highly formal ceremony that survives to this day.' },
              { number: 12, text: 'What type of fast sailing ship took part in the nineteenth-century tea races?', evidence: 'fast sailing ships known as clippers raced one another across the oceans' },
              { number: 13, text: 'Which country became one of the largest producers of tea under British rule?', evidence: 'The hills of India proved well suited to the plant, and vast plantations were established there' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'reefs are found almost entirely in the tropics, in a belt that circles the Earth on either side of the equator' },
              { number: 15, text: 'Paragraph B', evidence: 'it is in fact the work of countless tiny animals over immense spans of time' },
              { number: 16, text: 'Paragraph C', evidence: 'What makes this growth possible is one of the most remarkable partnerships in nature.' },
              { number: 17, text: 'Paragraph D', evidence: 'The reef that the corals build becomes a home for an astonishing variety of other creatures.' },
              { number: 18, text: 'Paragraph E', evidence: 'Perhaps most importantly of all, a reef acts as a natural breakwater.' },
              { number: 19, text: 'Paragraph F', evidence: 'the gravest threat comes from the warming of the oceans' },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'Corals grow only in warm, clear, shallow water.', evidence: 'The reef-building corals that create them can grow only in warm, clear and shallow seawater' },
              { number: 21, text: 'Each polyp builds a cup of limestone around itself.', evidence: 'each polyp draws minerals from the seawater to build a hard cup of limestone around itself for protection' },
              { number: 22, text: 'A reef absorbs the force of the waves before they reach land.', evidence: 'By absorbing the force of the waves before they reach the shore, it shields the coast behind it' },
              { number: 23, text: 'Coral turns white when it expels its algae.', evidence: 'the coral expels the algae that live within it, and without its partners the coral loses both its colour' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'The largest reef on Earth is found off the coast of', evidence: 'the largest of them all, the Great Barrier Reef off the coast of Australia, stretches for more than two thousand kilometres', options: [{ value: 'A', label: 'Africa.' }, { value: 'B', label: 'Australia.' }, { value: 'C', label: 'South America.' }] },
              { number: 25, text: 'The algae living inside coral provide the coral with', evidence: 'These tiny plants capture the energy of sunlight and, in doing so, produce food which they share with their coral hosts', options: [{ value: 'A', label: 'protection from predators.' }, { value: 'B', label: 'a hard skeleton.' }, { value: 'C', label: 'food made from sunlight.' }] },
              { number: 26, text: 'Coral bleaching is mainly caused by', evidence: 'When the water grows too hot, the coral expels the algae that live within it', options: [{ value: 'A', label: 'water that is too warm.' }, { value: 'B', label: 'too little salt in the sea.' }, { value: 'C', label: 'overfishing of the reef.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'The sleeping brain is far more active than people once believed.', evidence: 'Far from being idle, the sleeping brain is intensely busy' },
              { number: 28, text: 'Light has little effect on the body’s internal clock.', evidence: 'constantly reset by signals from the outside world, of which the most powerful is light' },
              { number: 29, text: 'Most people need exactly eight hours of sleep each night.' },
              { number: 30, text: 'Sleep helps the brain to store useful memories.', evidence: 'fresh memories are reviewed and filed away during the night' },
              { number: 31, text: 'Caffeine leaves the body within an hour of being consumed.', evidence: 'this stimulant can linger in the body for many hours and keep the brain alert long after it is wanted' },
            ],
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'this is the phase thought to be most important for physical rest and repair' },
              { number: 33, evidence: 'Sleep has also been linked to the clearing away of waste products that build up in the brain during the day.' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'The clock also drives a fall in body temperature at night' },
              { number: 35, evidence: 'constantly reset by signals from the outside world, of which the most powerful is light' },
              { number: 36, evidence: 'the brain begins to release a hormone that makes us feel drowsy and prepares the body for rest' },
              { number: 37, evidence: 'fresh memories are reviewed and filed away during the night' },
              { number: 38, evidence: 'the bright screens of phones and computers are especially troublesome' },
              { number: 39, evidence: 'Experts advise keeping to a regular routine' },
              { number: 40, evidence: 'steering clear of caffeine in the afternoon and evening' },
            ],
          },
        ],
      },
