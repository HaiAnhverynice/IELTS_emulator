        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Maps are older than writing.', evidence: 'People have been making maps for far longer than they have been writing.' },
              { number: 2, text: 'Some very old maps were made on clay.', evidence: 'Some of the oldest surviving maps are marks scratched on pieces of clay thousands of years ago' },
              { number: 3, text: 'Early maps were usually highly accurate.', evidence: 'For most of history, maps were rough and often inaccurate.' },
              { number: 4, text: 'Ancient sand maps have been found by archaeologists.' },
              { number: 5, text: 'The compass helped sailors keep a steady direction.', evidence: 'The compass allowed sailors to hold a steady direction out of sight of land' },
              { number: 6, text: 'Modern maps are still drawn mainly by hand.', evidence: 'Today maps are made not by hand but from images taken by satellites' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'Some of the oldest maps were scratched on ___.', evidence: 'Some of the oldest surviving maps are marks scratched on pieces of clay thousands of years ago' },
              { number: 8, text: 'During the age of exploration, sailors carefully charted ___.', evidence: 'the careful charting of coastlines became one of the great projects of the age of exploration' },
              { number: 9, text: 'The ___ let sailors hold a direction out of sight of land.', evidence: 'The compass allowed sailors to hold a steady direction out of sight of land' },
              { number: 10, text: 'Modern maps are made from images taken by ___.', evidence: 'maps are made not by hand but from images taken by satellites' },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'Besides decoration, what filled the blank areas of early maps?', evidence: 'large blank areas were filled with decoration or imagination' },
              { number: 12, text: 'What did later instruments help sailors fix more precisely?', evidence: 'later instruments let them fix their position more precisely' },
              { number: 13, text: 'What does a map turn into something we can hold in the mind?', evidence: 'a way of turning the bewildering complexity of the world into something we can hold in the mind' },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            options: headings,
            questions: [
              { number: 14, text: 'Paragraph A', evidence: 'Most of them lie along the edges of the great plates that make up the Earth’s surface' },
              { number: 15, text: 'Paragraph B', evidence: 'To understand an eruption you have to look downward.' },
              { number: 16, text: 'Paragraph C', evidence: 'Not all eruptions are alike.' },
              { number: 17, text: 'Paragraph D', evidence: 'it may seem strange that millions choose to live in a volcano’s shadow' },
              { number: 18, text: 'Paragraph E', evidence: 'Scientists cannot yet say exactly when a volcano will erupt, but they are no longer helpless.' },
              { number: 19, text: 'Paragraph F', evidence: 'Over billions of years their eruptions helped create the atmosphere and the oceans' },
            ],
          },
          {
            ...
            questions: [
              { number: 20, text: 'a warning sign caused by magma moving below', evidence: 'By tracking small earthquakes, swelling of the ground and changes in the gases a volcano releases' },
              { number: 21, text: 'a sign that the surface is being pushed upward', evidence: 'swelling of the ground' },
              { number: 22, text: 'a benefit produced when ash breaks down', evidence: 'the ash that volcanoes throw out breaks down into some of the richest farmland on Earth' },
              { number: 23, text: 'tracked, along with gases, to predict eruptions', evidence: 'By tracking small earthquakes, swelling of the ground and changes in the gases a volcano releases, they can often warn that an eruption is approaching' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'Most volcanoes are found', evidence: 'Most of them lie along the edges of the great plates that make up the Earth’s surface', options: [{ value: 'A', label: 'in the centre of oceans.' }, { value: 'B', label: 'along the edges of plates.' }, { value: 'C', label: 'near the poles.' }] },
              { number: 25, text: 'A volcano explodes violently when the magma is', evidence: 'Where it is thick and full of gas, the pressure can build until the volcano explodes with terrible force', options: [{ value: 'A', label: 'thin and runny.' }, { value: 'B', label: 'cold.' }, { value: 'C', label: 'thick and full of gas.' }] },
              { number: 26, text: 'People live near volcanoes mainly because of', evidence: 'the ash that volcanoes throw out breaks down into some of the richest farmland on Earth, and volcanic regions also offer minerals and, increasingly, clean geothermal energy', options: [{ value: 'A', label: 'fertile soil and energy.' }, { value: 'B', label: 'the fine views.' }, { value: 'C', label: 'cheaper housing.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'The novel was always a form intended only for the rich.', evidence: 'It is often said that the novel was, from the start, a form for the wealthy. In fact the opposite is closer to the truth' },
              { number: 28, text: 'Some early novels were published a chapter at a time.', evidence: 'some of the most popular were published in cheap instalments, a chapter at a time' },
              { number: 29, text: 'Circulating libraries helped spread the reading of novels.', evidence: 'Circulating libraries, which lent books for a small fee, put novels within reach of those who could not afford to buy them' },
              { number: 30, text: 'Television caused more harm to the novel than cinema did.' },
              { number: 31, text: 'The arrival of cinema made the novel disappear.', evidence: 'many predicted that the novel would fade away as audiences turned to moving pictures. It did not happen' },
            ],
          },
          {
            ...
            questions: [
              { number: 32, evidence: 'as a prosperous middle class expanded, the demand for stories grew' },
              { number: 33, evidence: 'Circulating libraries, which lent books for a small fee, put novels within reach of those who could not afford to buy them' },
            ],
          },
          {
            ...
            questions: [
              { number: 34, evidence: 'some of the most popular were published in cheap instalments, a chapter at a time' },
              { number: 35, evidence: 'as a prosperous middle class expanded, the demand for stories grew' },
              { number: 36, evidence: 'Circulating libraries, which lent books for a small fee, put novels within reach' },
              { number: 37, evidence: 'reading became a popular pastime rather than a privilege' },
              { number: 38, evidence: 'When the cinema arrived, and later television, many predicted that the novel would fade away' },
              { number: 39, evidence: 'The endless distractions of glowing screens' },
              { number: 40, evidence: 'whether readers can still summon the sustained attention that a novel demands' },
            ],
          },
        ],
      },
