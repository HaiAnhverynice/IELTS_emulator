        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'Many ships were wrecked close to land.' },
              { number: 2, text: 'The lighthouse at Alexandria was counted among the wonders of the ancient world.' },
              { number: 3, text: 'A brighter beam was achieved mainly by building a bigger flame.' },
              { number: 4, text: 'Lighthouse keepers were usually well paid for their work.' },
              { number: 5, text: 'Each lighthouse was given its own pattern of flashes.' },
              { number: 6, text: 'Modern ships still depend mainly on lighthouse beams to navigate.' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'The greatest early lighthouse was built at Alexandria in ___.' },
              { number: 8, text: 'For many centuries the light was a simple ___.' },
              { number: 9, text: 'Steadier, brighter light was later produced by lamps that burned ___.' },
              { number: 10, text: 'The oil lamp was eventually replaced by the ___ light.' },
            ],
          },
          {
            ...
            wordLimit: 'Choose ONE WORD ONLY from the passage for each answer.',
            questions: [
              { number: 11, text: 'A lighthouse warns sailors away from danger such as hidden what?' },
              { number: 12, text: 'What were placed around the lamp to bend the light into a single beam?' },
              { number: 13, text: 'How do almost all lighthouses now work, needing no keeper?' },
            ],
          },
        ],
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            questions: [
              { number: 20, text: 'taking bearings during the day' },
              { number: 21, text: 'finding direction at night' },
              { number: 22, text: 'an inner sense acting like a compass' },
              { number: 23, text: 'a skill that older birds learn over time' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'Before migrating, birds prepare by', options: [{ value: 'A', label: 'growing new feathers.' }, { value: 'B', label: 'storing fat as fuel.' }, { value: 'C', label: 'learning to swim.' }] },
              { number: 25, text: 'The bird that flies from the far north to the far south each year sees', options: [{ value: 'A', label: 'the fewest predators.' }, { value: 'B', label: 'the warmest seas.' }, { value: 'C', label: 'more daylight than any other creature.' }] },
              { number: 26, text: 'A warming climate threatens migrating birds because', options: [{ value: 'A', label: 'their food appears before they arrive.' }, { value: 'B', label: 'the nights become too long.' }, { value: 'C', label: 'the oceans grow too narrow.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Fear that machines will destroy work is a brand-new concern.' },
              { number: 28, text: 'Past waves of automation created new jobs as well as destroying old ones.' },
              { number: 29, text: 'Governments should pay people who lose their jobs to machines.' },
              { number: 30, text: 'Newer machines can take over some routine mental tasks.' },
              { number: 31, text: 'Creative work is easily done by today’s machines.' },
            ],
          },
          {
