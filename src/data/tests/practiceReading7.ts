        ...
        groups: [
          {
            ...
            questions: [
              { number: 1, text: 'The dog was the first animal humans domesticated.' },
              { number: 2, text: 'All modern dog breeds descend from the grey wolf.' },
              { number: 3, text: 'Wolves were domesticated at the same time as sheep.' },
              { number: 4, text: 'The way dogs were domesticated is fully agreed upon.' },
              { number: 5, text: 'A dog’s sense of smell is far better than a human’s.' },
              { number: 6, text: 'Most dogs today are working animals.' },
            ],
          },
          {
            ...
            questions: [
              { number: 7, text: 'Modern dogs are descended from grey ___.' },
              { number: 8, text: 'Some dogs were bred to help with ___.' },
              { number: 9, text: 'Other dogs were bred for ___ homes and livestock.' },
              { number: 10, text: 'Selecting useful animals created hundreds of ___.' },
            ],
          },
          {
            ...
            questions: [
              { number: 11, text: 'What sense of a dog is far more sensitive than a human’s?' },
              { number: 12, text: 'Which animals were dogs bred to herd?' },
              { number: 13, text: 'What are most dogs kept as today?' },
            ],
          },
        ],
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            questions: [
              { number: 20, text: 'are pushed round by moving air' },
              { number: 21, text: 'holds the machine high above the ground' },
              { number: 22, text: 'turns rotation into electricity' },
              { number: 23, text: 'carry the electricity to the grid' },
            ],
          },
          {
            id: 'r2c', type: 'mcq-single', instructions: 'Choose the correct letter, A, B or C.',
            questions: [
              { number: 24, text: 'The earliest windmills were mainly used to', options: [{ value: 'A', label: 'make electricity.' }, { value: 'B', label: 'pump seawater.' }, { value: 'C', label: 'grind grain and lift water.' }] },
              { number: 25, text: 'Turbines have been made larger because bigger rotors', options: [{ value: 'A', label: 'are cheaper to build.' }, { value: 'B', label: 'capture more energy.' }, { value: 'C', label: 'are quieter.' }] },
              { number: 26, text: 'Offshore turbines are built at sea because winds there are', options: [{ value: 'A', label: 'stronger and steadier.' }, { value: 'B', label: 'warmer.' }, { value: 'C', label: 'easier to predict by season.' }] },
            ],
          },
        ],
      },
        ...
        groups: [
          {
            ...
            questions: [
              { number: 27, text: 'Remembering rebuilds an experience rather than replaying it.' },
              { number: 28, text: 'Memory is a completely accurate record of the past.' },
              { number: 29, text: 'Sleep helps to strengthen memories.' },
              { number: 30, text: 'Older people forget more than younger people.' },
              { number: 31, text: 'A single long study session is the best way to learn.' },
            ],
          },
          {
